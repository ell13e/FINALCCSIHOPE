          ...
          <div class="contact-map-card">
            <div class="contact-map-wrapper">
              <iframe
                ...
                title="Continuity Training Academy Location"
                aria-label="Map showing Continuity Training Academy location at The Maidstone Studios, New Cut Road, Maidstone, Kent ME14 5NZ"
              ></iframe>
            </div>
          </div>
        </div>
