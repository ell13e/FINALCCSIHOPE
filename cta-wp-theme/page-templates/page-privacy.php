  ...
  <section class="legal-content-section">
    <div class="container">
      <div class="legal-content">
        ...
        <p><strong>Continuity Training Academy</strong><br>
        ...
        <h2>8. Cookies</h2>
        <p>Our website uses cookies and similar tracking technologies to improve user experience and analyse website traffic. For detailed information about the cookies we use, please see our <a href="<?php echo esc_url(cta_page_url('cookie-policy')); ?>">Cookie Policy</a>.</p>
