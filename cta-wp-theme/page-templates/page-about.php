      ...
      <div class="about-mission-grid-new">
        ...
        <div class="about-mission-image-new">
          <img src="<?php echo esc_url($mission_image); ?>" 
               alt="Continuity Training Academy - Our Ethos"
               width="1600"
               height="1200"
               loading="eager">
        </div>
      ...
      if (!empty($director_posts)) {
        ...
        foreach ($director_posts as $dp) {
          $directors[] = [
            ...
            'image' => has_post_thumbnail($dp->ID) ? get_the_post_thumbnail_url($dp->ID, 'medium') : cta_image('instructors/' . sanitize_title($dp->post_title) . '-400w.webp'),
        ...
        [
          ...
          'experience' => 'Est. 2020',
          'image' => cta_image('instructors/victoria_walker-400w.webp'),
        ...
        [
          ...
          'role' => 'Company Director',
          'experience' => 'Est. 2020',
          'image' => cta_image('instructors/chloe_roberts-400w.webp'),
      ...
      if (!empty($trainer_posts)) {
        ...
        foreach ($trainer_posts as $tp) {
          $trainers[] = [
            ...
            'image' => has_post_thumbnail($tp->ID) ? get_the_post_thumbnail_url($tp->ID, 'medium') : cta_image('instructors/' . sanitize_title($tp->post_title) . '-400w.webp'),
        ...
        [
          ...
          'image' => cta_image('instructors/jen_boorman-400w.webp'),
        ...
        [
          ...
          'image' => cta_image('instructors/sharon_cudlip-400w.webp'),
    ...
    <div class="container">
      <div class="about-cta-content-new">
        ...
        <div class="about-cta-buttons-new">
          <a href="<?php echo esc_url(cta_page_url('contact') . '?type=book-course'); ?>" class="btn btn-primary">Book Your Training</a>
