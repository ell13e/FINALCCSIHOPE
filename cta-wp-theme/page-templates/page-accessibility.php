  ...
  <section class="legal-content-section">
    <div class="container">
      <div class="legal-content">
        <p>Continuity Training Academy is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.</p>
        ...
        <p>Continuity Training Academy takes the following measures to ensure accessibility:</p>
        <ul>
        ...
        <h2>5. Feedback</h2>
        <p>We welcome your feedback on the accessibility of Continuity Training Academy's website. Please let us know if you encounter accessibility barriers:</p>
        <ul>
          ...
          <li><strong>Contact form:</strong> <a href="<?php echo esc_url(cta_page_url('contact')); ?>">Contact Us</a></li>
        </ul>
        <p>We aim to respond to accessibility feedback within 5 business days.</p>

        <h2>6. Assessment Approach</h2>
        <p>Continuity Training Academy assessed the accessibility of this website through the following approaches:</p>
        <ul>
