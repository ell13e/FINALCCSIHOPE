...
$ga_enabled = !empty(get_option('cta_google_analytics_id', ''));
$fb_pixel_enabled = !empty(get_option('cta_facebook_pixel_id', ''));
$recaptcha_enabled = !empty(function_exists('cta_get_recaptcha_site_key') ? cta_get_recaptcha_site_key() : get_theme_mod('cta_recaptcha_site_key', ''));
?>
  ...
  <section class="legal-content-section">
    <div class="container">
      <div class="legal-content">
        <p>This Cookie Policy explains how Continuity Training Academy ("we", "us", "our") uses cookies and similar tracking technologies on our website <a href="https://www.continuitytrainingacademy.co.uk">https://www.continuitytrainingacademy.co.uk</a> ("Website").</p>
        <p>It should be read together with our <a href="<?php echo esc_url(cta_page_url('privacy-policy')); ?>">Privacy Policy</a>, which explains how we collect and use personal information.</p>
    ...
    <div class="container">
      <div class="legal-cta-content">
        ...
        <div class="legal-cta-buttons">
          ...
          <a href="<?php echo esc_url(cta_page_url('privacy-policy')); ?>" class="btn btn-secondary">Privacy Policy</a>
        </div>
      </div>
    </div>
  </section>
