    ...
    <div class="container">
      ...
      <div class="group-booking-contact">
        ...
        <div class="group-booking-contact-links">
          ...
          <a href="<?php echo esc_url(cta_page_url('contact') . '?type=schedule-call'); ?>" class="group-booking-contact-link">
    ...
    <div class="container">
      ...
      <div class="group-faq-cta">
        <div class="group-faq-cta-content">
          ...
          <a href="<?php echo esc_url(cta_page_url('contact')); ?>" class="btn btn-primary group-faq-cta-button">Contact Us</a>
        </div>
      </div>
    </div>
  </section>
