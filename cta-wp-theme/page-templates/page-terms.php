  ...
  <section class="legal-content-section">
    <div class="container">
      <div class="legal-content">
        <p>These Terms of Service ("Terms") govern your use of the website <a href="https://www.continuitytrainingacademy.co.uk">https://www.continuitytrainingacademy.co.uk</a> ("Website") operated by Continuity Training Academy ("we", "us", "our").</p>
        <p>By using the Website, you agree to be bound by these Terms. If you do not agree, you should stop using the Website.</p>

        <h2>1. About Us</h2>
        <p><strong>Continuity Training Academy</strong></p>
        ...
        <p>All payments for services are handled directly with Continuity Training Academy after an enquiry.</p>
        <p>We do not accept payments or store payment information through the Website.</p>

        <h2>7. Intellectual Property</h2>
        <p>All materials on the Website, including text, graphics, images, training descriptions, and branding, are owned by Continuity Training Academy or used under licence.</p>
        <p>You may:</p>
        <ul>
        ...
        <p>For details on how we collect and use personal data, please refer to our <a href="<?php echo esc_url(cta_page_url('privacy-policy')); ?>">Privacy Policy</a>.</p>

        <h2>10. Cookies</h2>
        <p>Our use of cookies and similar technologies is explained in our <a href="<?php echo esc_url(cta_page_url('cookie-policy')); ?>">Cookie Policy</a>.</p>
        ...
        <strong>Website contact form:</strong> <a href="<?php echo esc_url(cta_page_url('contact')); ?>">Contact Us</a><br>
    ...
    <div class="container">
      <div class="legal-cta-content">
        ...
        <div class="legal-cta-buttons">
          <a href="<?php echo esc_url(cta_page_url('contact')); ?>" class="btn btn-primary">Contact Us</a>
