                ...
                <?php if ($unsubscribed && !empty($email)) : ?>
                    <div style="text-align: center; padding: 40px 20px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #2b1b0e; margin-bottom: 30px;">
                            You will no longer receive newsletter emails from Continuity Training Academy.
                        </p>
                        <?php if (!empty($email)) : ?>
                ...
                <?php else : ?>
                    <div style="text-align: center; padding: 40px 20px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #2b1b0e; margin-bottom: 30px;">
                            ...
                            If you need assistance, please <a href="<?php echo esc_url(cta_page_url('contact')); ?>">contact us</a>.
                        </p>
                        <div style="margin-top: 40px;">
                            <a href="<?php echo esc_url(home_url('/')); ?>" class="btn btn-primary" style="display: inline-block;">
                                Return to Homepage
