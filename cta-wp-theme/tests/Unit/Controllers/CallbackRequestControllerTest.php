<?php
/**
 * Callback Request Controller Test
 *
...
use CTA\Controllers\CallbackRequestController;
...
class CallbackRequestControllerTest extends TestCase {
    ...
    private CallbackRequestController $controller;
    ...
    protected function setUp(): void {
        ...
        $this->controller = new CallbackRequestController($this->validator, $this->repository);
    }
    
    /** @test */
    public function it_can_be_instantiated(): void {
        $controller = new CallbackRequestController();
        
        $this->assertInstanceOf(CallbackRequestController::class, $controller);
    }
    ...
    public function it_accepts_validator_and_repository_via_constructor(): void {
        ...
        $controller = new CallbackRequestController($validator, $repository);
