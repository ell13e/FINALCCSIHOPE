 ...
 * @return string Content template
 */
function cta_get_cqc_article_template($topic = 'requirements') {
    $templates = [
        'requirements' => <<<HTML
 ...
 */
function cta_get_faq_template($category = 'general') {
    $templates = [
        'general' => [
            [
 ...
 */
function cta_get_course_comparison_template($courses = []) {
    if (empty($courses)) {
        return '';
    }
 ...
 */
function cta_get_page_intro_template($page_type, $context = []) {
    $templates = [
 ...
 */
function cta_get_cta_template($type = 'default') {
    $templates = [
