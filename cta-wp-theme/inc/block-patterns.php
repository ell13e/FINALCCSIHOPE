 ...
 */
function cta_register_pattern_category() {
    register_block_pattern_category('cta-patterns', [
        'label' => __('CTA Patterns', 'cta-theme'),
        'description' => __('Pre-designed content blocks for Continuity Training Academy', 'cta-theme'),
    ]);
}
add_action('init', 'cta_register_pattern_category');

/**
 * Register block patterns
 */
function cta_register_block_patterns() {
    
    // Call-to-Action Box
    $courses_url = esc_url(get_post_type_archive_link('course') ?: home_url('/courses/'));
    
    register_block_pattern('cta-theme/cta-box', [
        'title' => __('Call to Action Box', 'cta-theme'),
        'description' => __('A highlighted box with a call to action', 'cta-theme'),
...
<!-- /wp:group -->',
    ...
    register_block_pattern('cta-theme/checklist', [
        'title' => __('Checklist', 'cta-theme'),
        'description' => __('A styled list with checkmarks', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
<!-- /wp:list -->',
    ...
    // Key Points Box
    register_block_pattern('cta-theme/key-points', [
        'title' => __('Key Points Box', 'cta-theme'),
        'description' => __('Highlight key takeaways from your article', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
<!-- /wp:group -->',
    ...
    // Quote with Source
    register_block_pattern('cta-theme/quote-with-source', [
        'title' => __('Quote with Source', 'cta-theme'),
        'description' => __('A styled quote with attribution', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
<!-- /wp:quote -->',
    ...
    register_block_pattern('cta-theme/comparison', [
        'title' => __('Comparison Columns', 'cta-theme'),
        'description' => __('Compare two options side by side', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
<!-- /wp:columns -->',
    ...
    // Statistics/Numbers
    register_block_pattern('cta-theme/statistics', [
        'title' => __('Statistics Row', 'cta-theme'),
        'description' => __('Display impressive numbers or statistics', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
<!-- /wp:columns -->',
    ...
    // Course Link Card
    register_block_pattern('cta-theme/course-link', [
        'title' => __('Course Link Card', 'cta-theme'),
        'description' => __('Link to a related course', 'cta-theme'),
        'categories' => ['cta-patterns'],
...
add_action('init', 'cta_register_block_patterns');
