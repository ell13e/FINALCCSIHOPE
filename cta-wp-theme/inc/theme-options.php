 ...
 */
function cta_get_contact_info_from_options() {
    // Use Customizer-based function if available
    if (function_exists('cta_get_contact_info_from_customizer')) {
        return cta_get_contact_info_from_customizer();
    }
 ...
 * @return mixed
 */
function cta_get_seo_option($key, $default = '') {
    // Use Customizer-based function if available
    if (function_exists('cta_get_seo_setting')) {
        return cta_get_seo_setting($key, $default);
    }
    ...
    $defaults = [
        ...
        'org_name' => 'Continuity Training Academy',
 ...
 * @return mixed
 */
function cta_get_theme_option($key, $default = '') {
    $customizer_keys = [
        'trustpilot_url' => 'cta_trustpilot_url',
        'trustpilot_rating' => 'cta_trustpilot_rating',
        'trustpilot_review_count' => 'cta_trustpilot_review_count',
        'default_course_location' => 'cta_default_course_location',
        'booking_email' => 'cta_booking_email',
    ];
 ...
 */
function cta_get_trustpilot_stars($rating) {
