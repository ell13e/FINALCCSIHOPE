...
function cta_resource_downloads_admin_menu() {
    add_submenu_page(
        'edit.php?post_type=cta_resource',
        'Resource Downloads',
        'Downloads',
        'edit_posts',
        'cta-resource-downloads',
        'cta_resource_downloads_admin_page'
    );
}
add_action('admin_menu', 'cta_resource_downloads_admin_menu', 30);
    ...
    <div class="wrap">
        ...
        <div class="tablenav top">
            <form method="get" action="" style="display: inline-block;">
                <input type="hidden" name="post_type" value="cta_resource">
                ...
                <?php if ($resource_filter > 0 || !empty($search)) : ?>
                    <a href="<?php echo esc_url(admin_url('edit.php?post_type=cta_resource&page=cta-resource-downloads')); ?>" class="button">Clear</a>
                <?php endif; ?>
            </form>
            
            <div class="alignright actions">
                <a href="<?php echo esc_url(admin_url('edit.php?post_type=cta_resource&page=cta-resource-downloads&export=csv')); ?>" class="button">
        ...
        <?php if ($total_downloads === 0) : ?>
            ...
            <div class="notice notice-info inline">
                ...
                <p>Once visitors request resources, their information will appear here. <a href="<?php echo esc_url(admin_url('post-new.php?post_type=cta_resource')); ?>">Add a resource</a> to get started.</p>
            </div>
        <?php else : ?>
            <!-- Downloads table -->
 ...
 * Handle CSV export
 */
function cta_resource_downloads_export_csv() {
...
add_action('admin_init', 'cta_resource_downloads_export_csv');
