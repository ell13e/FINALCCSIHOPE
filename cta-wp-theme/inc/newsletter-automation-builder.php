 ...
 */
function cta_get_flow_templates() {
    return [
        [
            'name' => 'Welcome Series',
 ...
 */
function cta_render_flow_builder($flow = null) {
    global $wpdb;
    ...
    if (!$flow && isset($_GET['template'])) {
        ...
        $templates = cta_get_flow_templates();
 ...
 */
function cta_render_flow_templates() {
    $templates = cta_get_flow_templates();
    ?>
    <div class="wrap">
 ...
 * Save flow steps
 */
function cta_save_flow_steps($flow_id, $steps) {
    global $wpdb;
 ...
 */
function cta_render_template_builder($template = null) {
