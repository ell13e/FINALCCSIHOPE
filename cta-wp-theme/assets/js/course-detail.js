...
(function() {
  ...
  function populatePage(course) {
    // Update page title
    const pageTitle = `${course.title} | Continuity Training Academy`;
    document.title = pageTitle;
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    const descriptionText = `Learn about ${course.title} at Continuity Training Academy. CQC-compliant, CPD-accredited training in Kent.`;
    if (metaDescription) {
