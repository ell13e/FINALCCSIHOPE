(function () {
  ...
  function getAjaxConfig() {
    if (typeof window.ctaData !== 'object' || !window.ctaData) return null;
    if (!window.ctaData.ajaxUrl || !window.ctaData.nonce) return null;
    return { ajaxUrl: window.ctaData.ajaxUrl, nonce: window.ctaData.nonce };
  }
