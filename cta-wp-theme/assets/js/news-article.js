...
function renderArticle(article) {
  ...
  if (titleMeta) {
    titleMeta.textContent = `${article.title} - Continuity Training Academy`;
  }
...
function updateMetaTags(article) {
  ...
  if (ogTitle) ogTitle.setAttribute('content', `${article.title} - Continuity Training Academy`);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typeof wp !== 'undefined' || typeof ctaData !== 'undefined') {
    return;
  }
