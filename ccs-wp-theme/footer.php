...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (newsletterForm) {
    ...
    newsletterForm.addEventListener('submit', function(e) {
      ...
      formData.append('action', 'ccs_newsletter_signup');
...
// SECURITY NOTE: reCAPTCHA site key is public by design and must be in frontend code.
// The secret key is server-side only and never exposed.
