  ...
  <div class="header-container">
    <div class="header-inner-wrapper">
      <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-link" aria-label="<?php bloginfo('name'); ?> Home">
        <img srcset="<?php echo esc_url(ccs_image('logo/long_logo-400w.webp')); ?> 400w,
                     <?php echo esc_url(ccs_image('logo/long_logo-800w.webp')); ?> 800w,
      ...
      <nav class="nav-desktop" aria-label="Primary navigation">
        ...
        <a href="<?php echo esc_url(get_post_type_archive_link('care_service') ?: home_url('/services/')); ?>" class="nav-link<?php echo is_post_type_archive('care_service') ? ' nav-link-active' : ''; ?>">Services</a>
        ...
        <div class="nav-item-dropdown">
          <a href="<?php echo esc_url(ccs_page_url('group-training')); ?>" class="nav-link">Group Training</a>
        </div>
          ...
          <div id="resources-dropdown" class="dropdown-menu" role="menu" aria-labelledby="resources-link">
            ...
            if ($use_resources_menu) {
                wp_nav_menu([
                    ...
                    'walker' => new CCS_Resources_Walker(),
                    'depth' => 1,
                ]);
            } else {
                ccs_resources_fallback_menu();
            }
            ?>
          </div>
        </div>
      ...
      <?php $contact = ccs_get_contact_info(); ?>
      <div class="header-actions">
        ...
        <a href="<?php echo esc_url(ccs_page_url('contact') . '?type=schedule-call'); ?>" class="btn btn-primary btn-header-cta">Contact Us</a>
      </div>
    </div>
    ...
    <div id="mobile-menu" class="mobile-menu" role="dialog" aria-modal="true" aria-label="Mobile navigation">
      <nav class="mobile-menu-content" id="mobile-menu-content" aria-label="Mobile navigation">
        ...
        <a href="<?php echo esc_url(get_post_type_archive_link('care_service') ?: home_url('/services/')); ?>" class="mobile-menu-link">Services</a>
        <div class="accordion" data-accordion-group="mobile-nav">
          ...
          <div id="mobile-courses-content" class="accordion-content" aria-hidden="true">
            ...
            <?php foreach (ccs_get_course_categories() as $category) : ?>
        ...
        <div class="accordion" data-accordion-group="mobile-nav">
          ...
          <div id="mobile-resources-content" class="accordion-content" aria-hidden="true">
            <a href="<?php echo esc_url(ccs_page_url('cqc-compliance-hub')); ?>" class="mobile-menu-link mobile-menu-link-sub">CQC Compliance Hub</a>
            <a href="<?php echo esc_url(ccs_page_url('downloadable-resources')); ?>" class="mobile-menu-link mobile-menu-link-sub">Downloadable Resources</a>
            <a href="<?php echo esc_url(ccs_page_url('news')); ?>" class="mobile-menu-link mobile-menu-link-sub">News & Articles</a>
            <a href="<?php echo esc_url(ccs_page_url('faqs')); ?>" class="mobile-menu-link mobile-menu-link-sub">FAQs</a>
          </div>
        </div>
        <a href="<?php echo esc_url(ccs_page_url('contact') . '?type=schedule-call'); ?>" class="mobile-menu-link">Contact</a>
